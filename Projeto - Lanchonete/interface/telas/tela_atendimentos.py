...
class TelaAtendimentos(Tela):
    def abrir_atendimento(self) -> None:
        ...
        try:
            ...
            self._lanchonete.abrir_atendimento(num_mesa)
    ...
    def consultar_atendimento(self) -> None:
        ...
        try:
            num_mesa: int = int(input("Número da mesa: "))
            atendimento = self._lanchonete.buscar_atendimento_ativo_por_mesa(num_mesa)
    ...
    def registrar_pedido(self) -> None:
        ...
        try:
            ...
            self._lanchonete.registrar_pedido(num_mesa, cod_produto, quantidade)
    ...
    def registrar_pagamento(self) -> None:
        ...
        try:
            ...
            self._lanchonete.registrar_pagamento(num_mesa, valor)
    ...
    def encerrar_atendimento(self) -> None:
        ...
        try:
            num_mesa: int = int(input("Número da mesa: "))
            self._lanchonete.encerrar_atendimento(num_mesa)
    ...
    def consultar_historico(self) -> None:
        ...
        historico = self._lanchonete.consultar_historico()
        ...
        for at in historico:
            print(f"Mesa {at.mesa.numero} | Total Quitados: R$ {at.total:.2f} | Status: Encerrado")
